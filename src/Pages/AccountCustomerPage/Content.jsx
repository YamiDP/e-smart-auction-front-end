...
export const Content = () => {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
         ...
         setProvince(data);
         axios.get(API['buyerById']+user_id).then(function (responseSeller) {
            const dataBuyer = responseSeller.data;
           // setSeller(dataBuyer);
           setFullname(dataBuyer.fullname)
           setUsername(dataBuyer.username)
           setemail(dataBuyer.email)
           sethousenumber_street(dataBuyer.housenumber_street)
           setmobile(dataBuyer.mobile)
           setward(dataBuyer.ward)
           setzip_code(dataBuyer.zip_code)
